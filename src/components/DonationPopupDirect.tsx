            ...
            <div className="p-6 text-center space-y-2">
              <h2 className="text-2xl font-bold text-slate-800 flex items-center justify-center gap-2">
                ...
                <svg className="w-7 h-7" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M392.638 119.896c-20.056 0-38.929 7.808-53.12 22l-76.97 76.99c-5.551 5.53-14.6 5.568-20.15-.02l-76.711-76.693c-14.192-14.191-33.046-21.999-53.12-21.999h-15.098l97.416-97.416c30.344-30.344 79.523-30.344 109.867 0l97.138 97.138h-9.252zm0 271.294c-20.056 0-38.929-7.808-53.12-22l-76.97-76.99c-2.758-2.774-6.39-4.155-10.02-4.155-3.63 0-7.26 1.381-10.02 4.155l-76.711 76.693c-14.192 14.191-33.046 21.999-53.12 21.999h-15.098l97.416 97.416c30.344 30.344 79.523 30.344 109.867 0l97.138-97.138-9.362.02z" fill="#32BCAD"/>
                </svg>
              </h2>
