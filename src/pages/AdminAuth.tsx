...
const AdminAuth = () => {
  ...
  return <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-black relative overflow-hidden">
        {/* Full screen background with shield */}
        <AuthBackground />

        {/* Centered Auth Form */}
        <div className="w-full max-w-[420px] animate-fade-in relative z-10 p-4 sm:p-6">
          {/* Card with subtle background */}
          <div className="relative">
            <div className="relative bg-zinc-950/60 backdrop-blur-sm rounded-2xl border border-white/[0.06] p-6 sm:p-8 shadow-2xl">
              {/* Logo */}
              <div className="flex justify-center mb-6">
                <img 
                  src="/lovable-uploads/d52e11b1-5641-4090-be59-dfb6ab93ecae.png" 
                  alt="FurionPay" 
