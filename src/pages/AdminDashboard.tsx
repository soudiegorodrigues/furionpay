        ...
        <Card className="xl:col-span-3 h-full flex flex-col">
          ...
          <CardContent className="flex-1 flex flex-col">
            <div className="flex-1 min-h-[280px] sm:min-h-[320px] w-full">
              ...
              <BarChart data={chartData} margin={{
                ...
                bottom: isTabletOrSmaller ? 40 : 5
              }} barCategoryGap={chartFilter === 'today' ? '5%' : '20%'}>
                  <defs>
                  ...
                  <Bar dataKey="gerados" radius={[4, 4, 0, 0]} fill="url(#barGradientGenerated)" animationDuration={800} animationEasing="ease-out" barSize={chartFilter === 'today' ? 12 : undefined} />
                  <Bar dataKey="pagos" radius={[4, 4, 0, 0]} fill="url(#barGradientPaid)" animationDuration={800} animationEasing="ease-out" barSize={chartFilter === 'today' ? 12 : undefined} />
                </BarChart>
              </ResponsiveContainer>
            </div>
