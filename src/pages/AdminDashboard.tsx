...
const AdminDashboard = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
      ...
      {/* Chart - Visão Geral - Largura Total */}
              ...
              <BarChart data={chartData} margin={{ top: 30, right: 20, left: 10, bottom: 5 }}>
                ...
                <LabelList 
                  ...
                  content={(props: any) => {
                    ...
                    const fontSize = chartFilter === 'today' ? 11 : chartFilter === '30days' ? 12 : 13;
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-xl sm:text-2xl font-bold text-foreground mt-1">{formatCurrency(todayStats.amountPaid)}</p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-xl sm:text-2xl font-bold text-foreground mt-1">{formatCurrency(monthStats.amountPaid)}</p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-xl sm:text-2xl font-bold text-foreground mt-1">{formatCurrency(totalBalance)}</p>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs sm:text-sm font-semibold text-primary">Recompensas</span>
              </div>
