...
const FinanceDashboard = lazy(() => import("@/components/finance/FinanceDashboard").then(m => ({
  default: m.FinanceDashboard
})));
const FinanceCategories = lazy(() => import("@/components/finance/FinanceCategories").then(m => ({
  default: m.FinanceCategories
})));
...
const FinanceReportGenerator = lazy(() => import("@/components/finance/FinanceReportGenerator").then(m => ({
  default: m.FinanceReportGenerator
})));

// Lightweight tab skeleton for instant feedback
const TabSkeleton = memo(() => <div className="space-y-4">
...
const AdminGestaoFinanceira = () => {
  ...
  if (authLoading || permissionsLoading) {
    return <div className="p-4 md:p-8 lg:p-10 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm md:text-base">
            Controle suas receitas, despesas, investimentos                                        
          </p>
        </div>
