-- Fix timezone logic in get_user_transactions_paginated (RETURNS jsonb overload with p_search)
-- This is the overload used by /admin/vendas page
...
BEGIN
  ...
  CASE p_date_filter
    WHEN 'today' THEN
      -- Start of today in São Paulo timezone
