-- Fix: Correct the constraint name in the RPC function
...
BEGIN
  ...
  -- 1. Update default_acquirer in admin_settings (FIXED: correct constraint name)
  INSERT INTO public.admin_settings (key, value, user_id, created_at, updated_at)
  VALUES ('default_acquirer', p_acquirer, NULL, now(), now())
  ON CONFLICT ON CONSTRAINT admin_settings_key_user_unique
