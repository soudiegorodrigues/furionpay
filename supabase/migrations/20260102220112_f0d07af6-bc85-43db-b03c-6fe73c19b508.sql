...
-- Recriar com os campos countdown_color e countdown_text
CREATE FUNCTION public.get_public_checkout_config(p_product_id uuid)
RETURNS TABLE(
  id uuid,
  product_id uuid,
  template text,
...
BEGIN
  ...
  SELECT 
    ...
    pcc.countdown_color, pcc.countdown_text,
    ...
    pcc.show_security_badges, pcc.user_id, pcc.delivery_description
