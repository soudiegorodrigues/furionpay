-- Atualizar RPC para incluir estimated_fees_generated (taxas estimadas para transações pendentes)
...
BEGIN
  ...
  SELECT json_build_object(
    ...
    -- NOVO: Estimated fees for generated transactions (using stored fees or default 6.99% + 2.49)
    ...
    -- Fees from PAID transactions in the period with filters
