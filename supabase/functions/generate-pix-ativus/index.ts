...
async function logPixGenerated(
  ...
  try {
    console.log('[ATIVUS] Calling log_pix_generated_user RPC (status will be generated by RPC, NOT passed as param)');
    console.log('[ATIVUS] Using RPC version that hardcodes status=generated');
    console.log('[ATIVUS] Order bumps to save:', orderBumps ? JSON.stringify(orderBumps) : 'none');
